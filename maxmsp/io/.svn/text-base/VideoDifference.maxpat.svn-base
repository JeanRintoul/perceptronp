{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 30.0, 52.0, 1040.0, 678.0 ],
		"bglocked" : 0,
		"defrect" : [ 30.0, 52.0, 1040.0, 678.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 629.0, 96.0, 72.0, 20.0 ],
					"id" : "obj-5",
					"fontname" : "Arial",
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 433.0, 372.0, 150.0, 34.0 ],
					"id" : "obj-11",
					"fontname" : "Arial",
					"numoutlets" : 0
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 2,
					"patching_rect" : [ 927.0, 151.0, 32.5, 20.0 ],
					"id" : "obj-4",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "int" ]
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 0,
					"patching_rect" : [ 925.0, 126.0, 59.5, 20.0 ],
					"id" : "obj-3",
					"fontname" : "Arial",
					"numoutlets" : 4,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 598.0, 42.0, 60.0, 20.0 ],
					"id" : "obj-17",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "bang" ]
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 2,
					"patching_rect" : [ 786.0, 97.0, 56.0, 20.0 ],
					"id" : "obj-1",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "bang" ]
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 996.0, 128.0, 50.0, 20.0 ],
					"id" : "obj-41",
					"fontname" : "Arial",
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ]
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 2,
					"patching_rect" : [ 999.0, 76.0, 136.0, 18.0 ],
					"id" : "obj-39",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "" ]
...
, 			{
				"box" : 				{
					...
					"items" : [ "Off", ",", "On" ],
					"numinlets" : 1,
					"patching_rect" : [ 996.0, 103.0, 100.0, 20.0 ],
					"presentation" : 1,
					"id" : "obj-36",
					"fontname" : "Arial",
					"numoutlets" : 3,
...
, 			{
				"box" : 				{
					"maxclass" : "button",
					"numinlets" : 1,
					"patching_rect" : [ 1002.0, 201.0, 20.0, 20.0 ],
					"id" : "obj-32",
					"numoutlets" : 1,
					"outlettype" : [ "bang" ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 986.0, 170.0, 46.0, 20.0 ],
					"id" : "obj-28",
					"fontname" : "Arial",
					"numoutlets" : 3,
...
, 			{
				"box" : 				{
					"maxclass" : "button",
					"numinlets" : 1,
					"patching_rect" : [ 981.0, 200.0, 20.0, 20.0 ],
					"id" : "obj-18",
					"numoutlets" : 1,
					"outlettype" : [ "bang" ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 2,
					"patching_rect" : [ 715.0, 53.0, 39.0, 18.0 ],
					"id" : "obj-117",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "" ]
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"patching_rect" : [ 629.0, 130.0, 117.0, 90.0 ],
					"presentation" : 1,
					"id" : "obj-8",
					"numoutlets" : 2,
					"outlettype" : [ "", "" ]
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 2,
					"patching_rect" : [ 786.0, 121.0, 37.0, 18.0 ],
					"id" : "obj-7",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "" ]
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 2,
					"patching_rect" : [ 753.0, 74.0, 61.0, 18.0 ],
					"id" : "obj-12",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "" ]
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-1", 0 ],
					"hidden" : 0,
					"midpoints" : [ 990.5, 222.0, 853.0, 222.0, 853.0, 93.0, 795.5, 93.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 990.5, 222.0, 853.0, 222.0, 853.0, 60.0, 762.5, 60.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 1011.5, 231.0, 902.0, 231.0, 902.0, 39.0, 724.5, 39.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 638.5, 117.0, 504.0, 117.0, 504.0, 42.0, 173.5, 42.0 ]
				}
